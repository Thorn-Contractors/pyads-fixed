...
PORT_REALTIME_CORE: int = 200  # Real-time core
PORT_IO: int = 300
PORT_SPECIALTASK1: int = 301
PORT_SPECIALTASK2: int = 302
PORT_NC: int = 500
PORT_SPS1: int = 801  # Twincat 2 Runtime system 1
PORT_SPS2: int = 811  # Twincat 2 Runtime system 2
PORT_SPS3: int = 821  # Twincat 2 Runtime system 3
PORT_SPS4: int = 831  # Twincat 2 Runtime system 4
PORT_TC2PLC1: int = PORT_SPS1
PORT_TC2PLC2: int = PORT_SPS2
PORT_TC2PLC3: int = PORT_SPS3
PORT_TC2PLC4: int = PORT_SPS4
PORT_TC3PLC1: int = 851  # Twincat 3 Runtime system 1
PORT_TC3PLC2: int = 852  # Twincat 3 Runtime system 2
PORT_TC3PLC3: int = 853  # Twincat 3 Runtime system 3
PORT_TC3PLC4: int = 854  # Twincat 3 Runtime system 4
PORT_NOCKE: int = 900
...
ADSSTATE_CONFIG: int = 15  # system is in config mode
ADSSTATE_RECONFIG: int = 16  # system should restart in config mode
